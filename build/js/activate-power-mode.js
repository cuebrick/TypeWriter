...
(function webpackUniversalModuleDefinition(root, factory) {
	if ((typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object' && (typeof module === 'undefined' ? 'undefined' : _typeof(module)) === 'object') module.exports = factory();else if (typeof define === 'function' && define.amd) define([], factory);else if ((typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object') exports["POWERMODE"] = factory();else root["POWERMODE"] = factory();
})(undefined, function () {
		...
		/***/function (module, exports, __webpack_require__) {
			...
			function POWERMODE() {
				{
					// spawn particles
					var caret = getCaret();
					var numParticles = 5 + Math.round(Math.random() * 50);
					while (numParticles--) {
			...
			function loop() {
				...
				for (var i = 0; i < particles.length; ++i) {
					...
					context.fillRect(Math.round(particle.x - 1.5) - rect.left, Math.round(particle.y - 1.5) - rect.top, 10, 10);
					rendered = true;
				}
				if (rendered) {
					requestAnimationFrame(loop);
